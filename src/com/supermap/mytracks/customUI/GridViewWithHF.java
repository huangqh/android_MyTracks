 ...
 * See {@link GridViewWithHF#addHeaderView(View, Object, boolean)}
 * See {@link GridViewWithHF#addFooterView(View, Object, boolean)}
 */
public class GridViewWithHF extends GridView {
    ...
    public GridViewWithHF(Context context, AttributeSet attrs) {
        super(context, attrs);
        initHeaderGridView();
    }

    public GridViewWithHF(Context context, AttributeSet attrs, int defStyle) {
    ...
    private class FullWidthFixedViewLayout extends FrameLayout {
        ...
        @Override
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            int targetWidth = GridViewWithHF.this.getMeasuredWidth()
                    - GridViewWithHF.this.getPaddingLeft()
                    - GridViewWithHF.this.getPaddingRight();
